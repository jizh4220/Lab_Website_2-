	...
	for(let index = 0; index < players.length; index++)
		{
			...
			link = document.createTextNode(players[index].name);  
            a.appendChild(link);
            a.href = "#";
            a.onclick = function(){
            	switchPlayers(index);
...
function switchPlayers(playerNum){
	document.getElementById("p_year").innerHTML= players[playerNum].year;//Read in a cells current value
    ...
    var avp_yards = Math.floor(players[playerNum].pass_yards/players[playerNum].games_played);
    var avr_yards = Math.floor(players[playerNum].rushing_yards/players[playerNum].games_played);
    var avrec_yards = Math.floor(players[playerNum].receiving_yards/players[playerNum].games_played);
    document.getElementById("avg_p_yards").innerHTML = avp_yards;
    document.getElementById("avg_r_yards").innerHTML = avr_yards;
    document.getElementById("avg_rec_yards").innerHTML = avrec_yards;
}